...
| 版本 | 日期 | 要点 |
|------|------|------|
| v1.4.13 | 2026-08-18 | awr 单点 snap 重构（Oracle 风格 snap_id + awrrpt/awrdiff + cron 采样，含 replication/slot 采样器与 `awr status`）；新增 `osw_netstat`；sqlhc 支持 .gz 日志 |
